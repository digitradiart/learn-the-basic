...
# The r# Arithmetic operators: integer division
...
# Integer division can also be called floor division. You will definitely come across this term in the future.(6. // -4)
